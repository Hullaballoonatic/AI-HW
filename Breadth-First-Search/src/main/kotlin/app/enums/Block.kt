...
import app.functions.bytePairListOf
...
val blackSquaresToOccupiedSpacesMap: Map<Block, Pair<Byte,Byte>> = Block.BLACK_SQUARES.defaultOccupiedCoordinates.associate { Block.BLACK_SQUARES to it }.toImmutableMap()
