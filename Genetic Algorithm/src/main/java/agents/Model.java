...
class Model {
	...
	void initGame() throws Exception {
		BufferedImage bufferedImage = ImageIO.read(getGFX("terrain.png"));
		...
		sprites_blue = new ArrayList<>();
		sprites_red = new ArrayList<>();
		setPerspectiveBlue(secret_symbol);
		bombs_throwing = new ArrayList<>();
		bombs_flying = new ArrayList<>();
		bombs_exploding = new ArrayList<>();
		energy_blue = 1.0f;
		energy_red = 1.0f;
